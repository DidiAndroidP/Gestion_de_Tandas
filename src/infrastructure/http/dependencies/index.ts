...
const joinTandaUseCase = new JoinTandaUseCase(tandaRepo);
const startTandaUseCase = new StartTandaUseCase(tandaRepo);
const finishTandaUseCase = new FinishTandaUseCase(tandaRepo);
const closeTandaUseCase = new CloseTandaUseCase(tandaRepo);
const generateScheduleUseCase = new GenerateTandaScheduleUseCase(participantRepo, turnService);
...
const acceptInvitationUseCase = new AcceptInvitationUseCase(invitationRepo, participantRepo, tandaRepo);
...
export const authController = new AuthController(createUserUseCase, loginUseCase);
